...
export default function BusinessPage() {
  ...
  const onClickHandler = (urlAlias) => {
    const updatedNavigation = navigation.map((item) => ({
      ...item,
      current: item.href === urlAlias,
    }));
            ...
            <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
              <Routes>
                ...
                <Route
                  ...
                  exact
                  element={
                    <ReportsPage clickhandler={onClickHandler}></ReportsPage>
                  }
                ></Route>
                <Route
                ...
                <Route
                  ...
                  exact
                  element={
                    <Dashboard clickhandler={onClickHandler}></Dashboard>
                  }
                ></Route>
              </Routes>
            </div>
